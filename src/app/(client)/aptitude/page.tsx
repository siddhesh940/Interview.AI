  ...
  const availableModules = [
    {
      ...
      description: "Master mathematical concepts, arithmetic operations, percentages, ratios, and data interpretation.",
    ...
    },
    {
      ...
      description: "Develop critical thinking through puzzles, sequences, analogies, and logical deductions.",
    ...
    },
    {
      ...
      description: "Enhance vocabulary, grammar, reading comprehension, and verbal reasoning skills.",
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        >
          {availableModules.map((module, index) => {
            ...
            const progressPercent = Math.min(100, Math.round((categoryProg.attempted / module.totalQuestions) * 100));
            ...
            return (
              ...
              >
                <Card 
                  ...
                  style={{ border: `2px solid ${module.color === 'blue' ? '#bfdbfe' : module.color === 'purple' ? '#e9d5ff' : '#bbf7d0'}` }}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-600">
                        Weakest: <span className="font-semibold">{getWeakestArea()}</span> — Practice more to improve!
                      </p>
                    </div>
                  </div>
                </div>
